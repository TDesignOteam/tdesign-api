...
const FRAMEWORK_MAP = {
  ...
  'WebComponents(PC)': {
    ...
    getDocs: getVueApiDocs,
    titleMap: VUE_TITLE_MAP,
    commonTypePath: 'https://github.com/TDesignOteam/tdesign-web-components/blob/next/packages/shared/src/common/types.ts',
    componentPath: 'https://github.com/TDesignOteam/tdesign-web-components/blob/next/packages/components/',
