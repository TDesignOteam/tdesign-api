...
const FRAMEWORK_MAP = {
  ...
  'Omi(PC)': {
    iconPath: 'tdesign-icons-react',
    apiBasePath: `${BASE_PATH_URL}/tdesign-omi/src`,
    apiEnglishBasePath: '',
    usageDemoBasePath: `${BASE_PATH_URL}/tdesign-omi/src/$compName/_usage`,
    tsBasePath: `${BASE_PATH_URL}/tdesign-omi/src`,
    propsBasePath: `${BASE_PATH_URL}/tdesign-omi/src`,
    tsBaseFileName: 'USE_TYPE_NAME',
    globalPath: `${BASE_PATH_URL}/tdesign-omi/src/common.ts`,
    globalTplPath: path.resolve(__dirname, '../types/global/omi.tpl'),
    unitBasePath: '',
    getDocs: getVueApiDocs,
    titleMap: VUE_TITILE_MAP,
    commonTypePath: 'https://github.com/Tencent/tdesign-omi/blob/develop/src/common.ts',
    componentPath: 'https://github.com/Tencent/tdesign-omi/blob/develop/src/',
    commonRelativePath: '../common',
    componentRelativiePath: '../',
    vscodePath: `${BASE_PATH_URL}/vscode-tdesign/document/omi`,
    TNode,
  },
  'Vue(Mobile)': {
    iconPath: 'tdesign-icons-vue-next',
