...
const FRAMEWORK_MAP = {
  ...
  'VueNext(PC)': {
    ...
    unitBasePath: '',
    commonTypePath: 'https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/common.ts',
    componentPath: 'https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/',
    commonRelativePath: '../common',
    componentRelativiePath: '../',
    getDocs: getVueApiDocs,
    titleMap: VUE_TITLE_MAP,
    vscodePath: `${BASE_PATH_URL}/vscode-tdesign/document/vue3`,
    helperPath: `${BASE_PATH_URL}/tdesign-vue-next/packages/tdesign-vue-next/helper`,
  ...
  'React(PC)': {
    ...
    getDocs: getVueApiDocs,
    titleMap: VUE_TITLE_MAP,
    commonTypePath: 'https://github.com/Tencent/tdesign-react/blob/develop/packages/components/common.ts',
    componentPath: 'https://github.com/Tencent/tdesign-react/blob/develop/packages/components/',
    commonRelativePath: '../common',
    componentRelativiePath: '../',
  ...
  'WebComponents(PC)': {
    ...
    apiBasePath: `${BASE_PATH_URL}/tdesign-web-components/packages/components`,
    apiEnglishBasePath: '',
    usageDemoBasePath: `${BASE_PATH_URL}/tdesign-web-components/packages/components/$compName/_usage`,
    tsBasePath: `${BASE_PATH_URL}/tdesign-web-components/packages/components`,
    propsBasePath: `${BASE_PATH_URL}/tdesign-web-components/packages/components`,
    tsBaseFileName: 'USE_TYPE_NAME',
    globalPath: `${BASE_PATH_URL}/tdesign-web-components/packages/shared/src/common/types.ts`,
    globalTplPath: path.resolve(__dirname, '../types/global/web-components.tpl'),
    unitBasePath: '',
    getDocs: getVueApiDocs,
    titleMap: VUE_TITLE_MAP,
    commonTypePath: 'https://github.com/TDesignOteam/tdesign-web-components/blob/develop/packages/shared/src/common/types.ts',
    componentPath:'https://github.com/TDesignOteam/tdesign-web-components/blob/develop/packages/components/',
    commonRelativePath: '@tdesign/web-components-shared/common',
    componentRelativiePath: '../',
    vscodePath: '',
    TNode,
    chat: {
  ...
  'React(Mobile)': {
    ...
    globalTplPath: path.resolve(__dirname, '../types/global/react.tpl'),
    unitBasePath: '',
    commonTypePath: 'https://github.com/Tencent/tdesign-mobile-react/blob/develop/src/common.ts',
    componentPath: 'https://github.com/Tencent/tdesign-mobile-react/tree/develop/src/',
    commonRelativePath: '../common',
    componentRelativiePath: '../',
    getDocs: getVueApiDocs,
    titleMap: VUE_TITLE_MAP,
  ...
  Miniprogram: {
    ...
    unitBasePath: '',
    commonTypePath: 'https://github.com/Tencent/tdesign-miniprogram/blob/develop/packages/components/common/common.ts',
    componentPath: 'https://github.com/Tencent/tdesign-miniprogram/blob/develop/packages/components/',
  ...
  UniApp: {
    ...
    componentPath: 'https://github.com/tencent/tdesign-miniprogram/blob/develop/packages/uniapp-components/',
    commonRelativePath: '../common/common',
    componentRelativiePath: '../',
