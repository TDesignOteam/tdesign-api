...
const FRAMEWORK_MAP = {
    ...
    'VueNext(PC)': {
        ...
        unitBasePath: '',
        commonTypePath:
            'https://github.com/Tencent/tdesign-vue-next/blob/develop/src/common.ts',
        componentPath:
            'https://github.com/Tencent/tdesign-vue-next/tree/develop/src/',
        commonRelativePath: '../common',
        componentRelativiePath: '../',
        getDocs: getVueApiDocs,
        titleMap: VUE_TITLE_MAP,
    ...
    'React(PC)': {
        ...
        titleMap: VUE_TITLE_MAP,
        commonTypePath:
            'https://github.com/Tencent/tdesign-react/blob/develop/src/common.ts',
        componentPath:
            'https://github.com/Tencent/tdesign-react/blob/develop/src/',
        commonRelativePath: '../common',
        componentRelativiePath: '../',
