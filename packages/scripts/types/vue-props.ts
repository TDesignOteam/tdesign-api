...
import { FILE_RIGHTS_DESC } from '../config/const.ts';
import { FRAMEWORK_MAP, TYPES_COMBINE_MAP } from '../config/index.ts';
import { kebabCaseComponent } from '../utils.ts';
import { getComponentBasePath } from '../utils.ts';
import { fetchApiDataFromOfficialWebsite } from './miniprogram.ts';
...
function formatNormalProps(api, cmp, extraParams: { isUncontrolApi?: boolean; modelValue?: boolean } = {}) {
