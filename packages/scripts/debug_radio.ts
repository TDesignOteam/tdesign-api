...
import { formatArrayToMap, groupByComponent, getApiComponentMapByFrameWork } from './common.ts';
import { COMPONENT_API_MD_MAP, MOBILE_COMPONENT_API_MD_MAP, MOBILE_FRAMES } from './config/index.ts';
...
if (frameworkData['Radio']) {
  ...
  disabled.forEach((a) => {
    console.log(
      '  fdv:',
      JSON.stringify(a.field_default_value),
      'typeof:',
      typeof a.field_default_value,
      'fct:',
      a.field_category_text,
    );
