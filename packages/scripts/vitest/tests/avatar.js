export default {
  ...
  AvatarGroup: {
    cascading_1600: {
      ...
      PC: {
        snapshot: true,
        className: ['t-avatar--offset-left', 't-avatar--offset-right'],
      },
    },
    collapseAvatar_1643: {
        ...
        className: [
          {
            ...
            expect: [
              ...
              {
                dom: '.t-avatar:nth-child(5)',
                className: { 't-size-l': true },
              },
            ],
          },
          {
