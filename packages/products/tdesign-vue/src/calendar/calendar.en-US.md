...
value | String / Date | - | Typescript：`CalendarValue` `type CalendarValue = string \| Date \| Array<string \| Date>`。[see more ts definition](https://github.com/Tencent/tdesign-vue/tree/develop/src/calendar/type.ts) | N
