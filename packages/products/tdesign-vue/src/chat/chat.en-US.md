...
expand | Boolean | - | `v-model` is supported | N
...
onExpandChange | Function |  | Typescript：`(value: boolean) => void`<br/>Typescript：`TNode`。[see more ts definition](https://github.com/Tencent/tdesign-vue/blob/develop/src/common.ts) | N
