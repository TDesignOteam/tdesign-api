...
expand | Boolean | - | 支持语法糖 `v-model` | N
...
onExpandChange | Function |  | TS 类型：`(value: boolean) => void`<br/>展开图标点击事件。TS 类型：`TNode`。[通用类型定义](https://github.com/Tencent/tdesign-vue/blob/develop/src/common.ts) | N
