...
defaultValue | Array | [] | 值。非受控属性。TS 类型：`TagInputValue` `type TagInputValue = Array<string \| number>`。[详细类型定义](https://github.com/Tencent/tdesign-react/blob/develop/packages/components/tag-input/type.ts) | N
