...
shape | String | circle | 形状。可选项：circle/round。TS 类型：`AvatarShape` `type AvatarShape = 'circle' \| 'round'`。[详细类型定义](https://github.com/Tencent/tdesign-react/blob/develop/src/avatar/type.ts) | N
