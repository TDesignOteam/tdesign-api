...
value | String / Date | - | 当前高亮的日期。TS 类型：`CalendarValue` `type CalendarValue = string \| Date \| Array<string \| Date>`。[详细类型定义](https://github.com/Tencent/tdesign-react/blob/develop/src/calendar/type.ts) | N
