 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Guide React(PC) vitest,finalProject`
...
describe('Guide Component', () => {
  it('props.counter works fine', async () => {
    getGuideDefaultMount(Guide, { counter: <span className="custom-node">TNode</span> });
    await mockDelay(10);
...
describe('Guide Component', () => {
  it('GuideStep.body works fine', async () => {
    getCustomGuideStepMount(Guide, { body: <span className="custom-node">TNode</span> });
    await mockDelay(10);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
  ...
  it('GuideStep.children works fine', async () => {
    getCustomGuideStepMount(Guide, { children: <span className="custom-node">TNode</span> });
    await mockDelay(10);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('GuideStep.content works fine', async () => {
    getCustomGuideStepMount(Guide, { content: <span className="custom-node">TNode</span> });
    await mockDelay(10);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('GuideStep.highlightContent works fine', async () => {
    getCustomGuideStepMount(Guide, { highlightContent: <span className="custom-node">TNode</span> });
    await mockDelay(10);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('GuideStep.title works fine', async () => {
    getCustomGuideStepMount(Guide, { title: <span className="custom-node">TNode</span> });
    await mockDelay(10);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
