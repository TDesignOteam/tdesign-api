...
range | Array / Function | - | Typescript: `PickerDateRange` `type PickerDateRange = [DateValue, DateValue] \| ((date: DateValue) => boolean)`。[see more ts definition](https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/date-picker/type.ts) | N
...
presetsPlacement | String | bottom | options: left/top/right/bottom | N
range | Array / Function | - | Typescript: `PickerDateRange \| [PickerDateRange, PickerDateRange]` `type PickerDateRange = [DateValue, DateValue] \| ((date: DateValue) => boolean)`。[see more ts definition](https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/date-picker/type.ts) | N
