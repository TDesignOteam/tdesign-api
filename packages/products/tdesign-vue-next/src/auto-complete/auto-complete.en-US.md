...
onChange | Function |  | Typescript：`(value: string, context?: { e?: InputEvent \| MouseEvent \| KeyboardEvent \| any }) => void`<br/> | N
...
onSelect | Function |  | Typescript：`(value: string, context: { e: MouseEvent \| KeyboardEvent \| any }) => void`<br/> | N
...
change | `(value: string, context?: { e?: InputEvent \| MouseEvent \| KeyboardEvent \| any })` | \-
...
select | `(value: string, context: { e: MouseEvent \| KeyboardEvent \| any })` | \-
