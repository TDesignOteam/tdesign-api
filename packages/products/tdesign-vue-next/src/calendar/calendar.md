...
value | String / Date | - | 当前高亮的日期，如果是数组则表示多个日期高亮。TS 类型：`CalendarValue` `type CalendarValue = string \| Date \| Array<string \| Date>`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/calendar/type.ts) | N
