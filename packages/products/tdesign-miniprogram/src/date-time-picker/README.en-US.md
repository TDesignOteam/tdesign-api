...
filter | Function | - | Typescript：`(type: TimeModeValues, columns: PickerColumn) => PickerColumn `，[Picker API Documents](./picker?tab=api)。[see more ts definition](https://github.com/Tencent/tdesign-miniprogram/tree/develop/src/date-time-picker/type.ts) | N
