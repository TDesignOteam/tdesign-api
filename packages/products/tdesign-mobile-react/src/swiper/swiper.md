...
navigation | TNode | true | 导航器全部配置。TS 类型：`SwiperNavigation \| TNode \| Function \| Boolean `。[通用类型定义](https://github.com/Tencent/tdesign-mobile-react/blob/develop/src/common.ts) | N
