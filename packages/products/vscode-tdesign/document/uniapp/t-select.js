...
empty | String / TNode | - | 当下拉列表为空时显示的内容。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
filterable | Boolean | - | 是否可搜索，默认搜索规则不区分大小写，全文本任意位置匹配。如果默认搜索规则不符合业务需求，可以更为使用 \`filter\` 自定义过滤规则 | N
inputProps | Object | - | 透传 Input 输入框组件的全部属性。TS 类型：\`InputProps\`，[Input API Documents](./input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
inputValue | String / Number | - | 输入框的值。TS 类型：\`string\` | N
defaultInputValue | String / Number | - | 输入框的值。非受控属性。TS 类型：\`string\` | N
keys | Object | - | 用来定义 value / label / disabled 在 \`options\` 中对应的字段别名。TS 类型：\`SelectKeysType\` \`interface SelectKeysType { value?: string \| ((option: SelectOption) => string); label?: string \| ((option: SelectOption) => string); disabled?: string }\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
...
popupProps | Object | - | 透传 Popup 组件全部属性。TS 类型：\`PopupProps\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
...
selectInputProps | Object | - | 透传 SelectInput 筛选器输入框组件的全部属性。TS 类型：\`SelectInputProps\`，[SelectInput API Documents](./select-input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
...
tagInputProps | Object | - | 透传 TagInput 标签输入框组件的全部属性。TS 类型：\`TagInputProps\`，[TagInput API Documents](./tag-input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
tagProps | Object | - | 透传 Tag 标签组件全部属性。TS 类型：\`TagProps\`，[Tag API Documents](./tag?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
...
value | String / Number / Boolean / Object / Array | - | 选中值。TS 类型：\`SelectValue\` \`type SelectValue<T extends SelectOption = SelectOption> = string \| number \| boolean \| T \| Array<SelectValue<T>>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
defaultValue | String / Number / Boolean / Object / Array | - | 选中值。非受控属性。TS 类型：\`SelectValue\` \`type SelectValue<T extends SelectOption = SelectOption> = string \| number \| boolean \| T \| Array<SelectValue<T>>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts) | N
valueDisplay | String / TNode | - | 自定义选中项呈现的内容。TS 类型：\`string \| TNode<{ value: SelectValue; onClose: (index: number) => void; displayValue?: SelectValue; label?: string }>\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
onChange | Function |  | TS 类型：\`(value: SelectValue, context: { option?: T, selectedOptions: T[], trigger: SelectValueChangeTrigger; e?: MouseEvent \| KeyboardEvent }) => void\`<br/>选中值变化时触发。\`context.trigger\` 表示触发变化的来源；\`context.selectedOptions\` 表示选中值的完整对象，数组长度一定和 \`value\` 相同；\`context.option\` 表示当前操作的选项，不一定存在。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`type SelectValueChangeTrigger = 'clear' \| 'tag-remove' \| 'backspace' \| 'check' \| 'uncheck' \| 'default'\`<br/> | N
...
onInputChange | Function |  | TS 类型：\`(value: string, context?: SelectInputValueChangeContext) => void\`<br/>输入框值发生变化时触发，\`context.trigger\` 表示触发输入框值变化的来源：文本输入触发、清除按钮触发、失去焦点等。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`import { SelectInputValueChangeContext } from '@SelectInput'\`<br/> | N
onPopupVisibleChange | Function |  | TS 类型：\`(visible: boolean, context: PopupVisibleChangeContext) => void\`<br/>下拉框显示或隐藏时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`import { PopupVisibleChangeContext } from '@Popup'\`<br/> | N
onRemove | Function |  | TS 类型：\`(options: SelectRemoveContext<T>) => void\`<br/>多选模式下，选中数据被移除时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`interface SelectRemoveContext<T> { value: string \| number; data: T; e: MouseEvent \| KeyboardEvent }\`<br/> | N
...
input-change | \`(value: string, context?: SelectInputValueChangeContext)\` | 输入框值发生变化时触发，\`context.trigger\` 表示触发输入框值变化的来源：文本输入触发、清除按钮触发、失去焦点等。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`import { SelectInputValueChangeContext } from '@SelectInput'\`<br/>
popup-visible-change | \`(visible: boolean, context: PopupVisibleChangeContext)\` | 下拉框显示或隐藏时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`import { PopupVisibleChangeContext } from '@Popup'\`<br/>
remove | \`(options: SelectRemoveContext<T>)\` | 多选模式下，选中数据被移除时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/select/type.ts)。<br/>\`interface SelectRemoveContext<T> { value: string \| number; data: T; e: MouseEvent \| KeyboardEvent }\`<br/>
...
children | String / TNode | - | 用于定义复杂的选项内容，同 content。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
content | String / TNode | - | 用于定义复杂的选项内容。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
default | String / TNode | - | 用于定义复杂的选项内容。同 content。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
