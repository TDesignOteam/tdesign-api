...
inputProps | Object | - | 透传给 输入框 Input 组件的全部属性。TS 类型：\`InputProps\`，[Input API Documents](./input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
inputValue | String / Number | - | 输入框的值。TS 类型：\`string\` | N
defaultInputValue | String / Number | - | 输入框的值。非受控属性。TS 类型：\`string\` | N
keys | Object | - | 用来定义 \`value / label / disabled / children\` 在 \`data\` 数据中对应的字段别名，示例：\`{ value: 'key', label: 'name', children: 'list' }\`。TS 类型：\`TreeKeysType\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
popupProps | Object | - | 透传 Popup 组件全部属性。TS 类型：\`PopupProps\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
...
selectInputProps | Object | - | 【开发中】透传 SelectInput 筛选器输入框组件的全部属性。TS 类型：\`SelectInputProps\`，[SelectInput API Documents](./select-input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
...
tagProps | Object | - | 透传 Tag 标签组件全部属性。TS 类型：\`TagProps\`，[Tag API Documents](./tag?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
...
treeProps | Object | - | 透传 Tree 组件的全部属性。TS 类型：\`TreeProps\`，[Tree API Documents](./tree?tab=api)。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
value | String / Number / Object / Array | - | 选中值，泛型 \`TreeValueType\` 继承自 \`TreeSelectValue\`。TS 类型：\`TreeValueType\` \`type TreeSelectValue = string \| number \| TreeOptionData \| Array<string \| number \| TreeOptionData>\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
...
value | String / Number / Array | - | 选中值。TS 类型：\`TreeSelectValue\` \`type TreeSelectValue = string \| number \| Array<TreeSelectValue>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
defaultValue | String / Number / Array | - | 选中值。非受控属性。TS 类型：\`TreeSelectValue\` \`type TreeSelectValue = string \| number \| Array<TreeSelectValue>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts) | N
valueDisplay | TNode | - | 自定义选中项呈现方式。TS 类型：\`string \| TNode<{ value: TreeOptionData \| TreeOptionData[]; onClose: (index: number) => void }>\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
onChange | Function |  | TS 类型：\`(value: TreeValueType, context: TreeSelectChangeContext<DataOption>) => void\`<br/>节点选中状态变化时触发，\`context.node\` 表示当前变化的选项，\`context. trigger\` 表示触发变化的来源。泛型 \`TreeValueType\` 继承自 \`TreeSelectValue\` 。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`interface TreeSelectChangeContext<DataOption> { node: TreeNodeModel<DataOption>; data: DataOption; index?: number; trigger: TreeSelectValueChangeTrigger; e?: MouseEvent \| KeyboardEvent \| Event }\`<br/><br/>\`type TreeSelectValueChangeTrigger = 'clear' \| 'tag-remove' \| 'backspace' \| 'check' \| 'uncheck'\`<br/> | N
onChange | Function |  | TS 类型：\`(value: TreeSelectValue, level: TreeLevel)  => void\`<br/>点击任何节点均会触发；level 代表当前点击的层级，0 代表最左侧，依次递进。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`type TreeLevel = 0 \| 1 \| 2\`<br/> | N
...
onPopupVisibleChange | Function |  | TS 类型：\`(visible: boolean, context: TreeSelectPopupVisibleContext<DataOption>) => void\`<br/>下拉框显示或隐藏时触发。单选场景，选中某个选项时触发关闭，此时需要添加参数 \`node\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`import { PopupVisibleChangeContext, PopupTriggerEvent, PopupTriggerSource } from '@Popup'\`<br/><br/>\`interface TreeSelectPopupVisibleContext<T> {   e?: PopupTriggerEvent \| Event;   node?: TreeNodeModel<T>;   trigger?: PopupTriggerSource \| 'clear'; }\`<br/> | N
onRemove | Function |  | TS 类型：\`(options: RemoveOptions<DataOption, TreeValueType>) => void\`<br/>多选模式下，选中数据被移除时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`export interface RemoveOptions<T extends TreeOptionData = TreeOptionData, N extends TreeSelectValue = TreeSelectValue> {   value: N;   data: T;  index: number; node: TreeNodeModel<T>;   e?: MouseEvent \| KeyboardEvent;   trigger: 'tag-remove' \| 'backspace'; }\`<br/> | N
...
change | \`(value: TreeValueType, context: TreeSelectChangeContext<DataOption>)\` | 节点选中状态变化时触发，\`context.node\` 表示当前变化的选项，\`context. trigger\` 表示触发变化的来源。泛型 \`TreeValueType\` 继承自 \`TreeSelectValue\` 。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`interface TreeSelectChangeContext<DataOption> { node: TreeNodeModel<DataOption>; data: DataOption; index?: number; trigger: TreeSelectValueChangeTrigger; e?: MouseEvent \| KeyboardEvent \| Event }\`<br/><br/>\`type TreeSelectValueChangeTrigger = 'clear' \| 'tag-remove' \| 'backspace' \| 'check' \| 'uncheck'\`<br/>
...
popup-visible-change | \`(visible: boolean, context: TreeSelectPopupVisibleContext<DataOption>)\` | 下拉框显示或隐藏时触发。单选场景，选中某个选项时触发关闭，此时需要添加参数 \`node\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`import { PopupVisibleChangeContext, PopupTriggerEvent, PopupTriggerSource } from '@Popup'\`<br/><br/>\`interface TreeSelectPopupVisibleContext<T> {   e?: PopupTriggerEvent \| Event;   node?: TreeNodeModel<T>;   trigger?: PopupTriggerSource \| 'clear'; }\`<br/>
remove | \`(options: RemoveOptions<DataOption, TreeValueType>)\` | 多选模式下，选中数据被移除时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tree-select/type.ts)。<br/>\`export interface RemoveOptions<T extends TreeOptionData = TreeOptionData, N extends TreeSelectValue = TreeSelectValue> {   value: N;   data: T;  index: number; node: TreeNodeModel<T>;   e?: MouseEvent \| KeyboardEvent;   trigger: 'tag-remove' \| 'backspace'; }\`<br/>
