...
statusRender | TNode | - | 自定义状态渲染器。TS 类型：\`(info:StatusRenderInfo) => TNode\` \`type StatusRenderInfo = {status:QRStatus;onRefresh?: () => void;}\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/qrcode/type.ts) | N
