...
inputProps | Object / Array | - | 透传 Input 输入框组件全部属性，数组第一项表示第一个输入框属性，第二项表示第二个输入框属性。示例：\`[{ label: 'A', name: 'A-name' }, { label: 'B',  name: 'B-name' }]\`。TS 类型：\`InputProps \| Array<InputProps>\`，[Input API Documents](./input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts) | N
label | String / TNode | - | 左侧内容。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
separator | String / TNode | '-' | 范围分隔符。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
value | Array | [] | 范围输入框的值。TS 类型：\`RangeInputValue\` \`type RangeInputValue = Array<InputValue>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts) | N
defaultValue | Array | [] | 范围输入框的值。非受控属性。TS 类型：\`RangeInputValue\` \`type RangeInputValue = Array<InputValue>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts) | N
onBlur | Function |  | TS 类型：\`(value: RangeInputValue, context?: { e?: FocusEvent; position?: RangeInputPosition }) => void\`<br/>范围输入框失去焦点时触发 | N
onChange | Function |  | TS 类型：\`(value: RangeInputValue, context?: { e?: InputEvent \| MouseEvent \| CompositionEvent; position?: RangeInputPosition; trigger?: 'input' \| 'initial' \| 'clear' })    => void\`<br/>范围输入框值发生变化时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts)。<br/>\`type RangeInputPosition = 'first' \| 'second' \| 'all'\`<br/> | N
...
change | \`(value: RangeInputValue, context?: { e?: InputEvent \| MouseEvent \| CompositionEvent; position?: RangeInputPosition; trigger?: 'input' \| 'initial' \| 'clear' })   \` | 范围输入框值发生变化时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts)。<br/>\`type RangeInputPosition = 'first' \| 'second' \| 'all'\`<br/>
...
popupProps | Object | - | 透传 Popup 组件全部属性。TS 类型：\`PopupProps\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts) | N
popupVisible | Boolean | - | 是否显示下拉框 | N
defaultPopupVisible | Boolean | - | 是否显示下拉框。非受控属性 | N
rangeInputProps | Object | - | 透传 RangeInput 组件全部属性。TS 类型：\`RangeInputProps\`，[RangeInput API Documents](./range-input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts) | N
readonly | Boolean | undefined | 只读状态，值为真会隐藏输入框，且无法打开下拉框 | N
status | String | default | 输入框状态。可选项：default/success/warning/error | N
tips | String / TNode | - | 输入框下方提示文本，会根据不同的 \`status\` 呈现不同的样式。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
onInputChange | Function |  | TS 类型：\`(value: RangeInputValue, context?: RangeInputValueChangeContext)  => void\`<br/>输入框值发生变化时触发，\`context.trigger\` 表示触发输入框值变化的来源：文本输入触发、清除按钮触发等。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts)。<br/>\`type RangeInputValueChangeContext = { e?: InputEvent \| MouseEvent; trigger?: 'input' \| 'clear', position?: RangeInputPosition }\`<br/> | N
onPopupVisibleChange | Function |  | TS 类型：\`(visible: boolean, context: PopupVisibleChangeContext) => void\`<br/>下拉框显示或隐藏时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts)。<br/>\`import { PopupVisibleChangeContext } from '@Popup'\`<br/> | N
...
popup-visible-change | \`(visible: boolean, context: PopupVisibleChangeContext)\` | 下拉框显示或隐藏时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/range-input/type.ts)。<br/>\`import { PopupVisibleChangeContext } from '@Popup'\`<br/>
