...
inputProps | Object | - | 透传 Input 输入框组件全部属性。TS 类型：\`InputProps\`，[Input API Documents](./input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts) | N
...
tag | String / TNode | - | 自定义标签的内部内容，每一个标签的当前值。注意和 \`valueDisplay\` 区分，\`valueDisplay\`  是用来定义全部标签内容，而非某一个标签。TS 类型：\`string \| TNode<{ value: string \| number }>\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
tagProps | Object | - | 透传 Tag 组件全部属性。TS 类型：\`TagProps\`，[Tag API Documents](./tag?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts) | N
...
value | Array | [] | 值。TS 类型：\`TagInputValue\` \`type TagInputValue = Array<string \| number>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts) | N
defaultValue | Array | [] | 值。非受控属性。TS 类型：\`TagInputValue\` \`type TagInputValue = Array<string \| number>\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts) | N
...
onChange | Function |  | TS 类型：\`(value: TagInputValue, context: TagInputChangeContext) => void\`<br/>值变化时触发，参数 \`context.trigger\` 表示数据变化的触发来源；\`context.index\` 指当前变化项的下标；\`context.item\` 指当前变化项；\`context.e\` 表示事件参数。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface TagInputChangeContext { trigger: TagInputTriggerSource; index?: number; item?: string \| number; e?: MouseEvent \| KeyboardEvent }\`<br/><br/>\`type TagInputTriggerSource = 'enter' \| 'tag-remove' \| 'backspace' \| 'clear'\`<br/> | N
onClear | Function |  | TS 类型：\`(context: { e: MouseEvent }) => void\`<br/>清空按钮点击时触发 | N
onClick | Function |  | TS 类型：\`(context: { e: MouseEvent }) => void\`<br/>点击组件时触发 | N
onDragSort | Function |  | TS 类型：\`(context: TagInputDragSortContext) => void\`<br/>【开发中】拖拽排序时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface TagInputDragSortContext { newTags: TagInputValue; currentIndex: number; current: string \| number; targetIndex: number; target: string \| number }\`<br/> | N
...
onInputChange | Function |  | TS 类型：\`(value: string, context?: InputValueChangeContext) => void\`<br/>输入框值发生变化时触发，\`context.trigger\` 表示触发输入框值变化的来源：文本输入触发、清除按钮触发、回车键触发等。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface InputValueChangeContext { e?: InputEvent \| MouseEvent \| CompositionEvent \| KeyboardEvent; trigger: 'input' \| 'clear' \| 'enter' \| 'blur'   }\`<br/> | N
...
onRemove | Function |  | TS 类型：\`(context: TagInputRemoveContext) => void\`<br/>移除单个标签时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface TagInputRemoveContext { value: TagInputValue; index: number; item: string \| number; e?: MouseEvent \| KeyboardEvent; trigger: TagInputRemoveTrigger }\`<br/><br/>\`type TagInputRemoveTrigger = 'tag-remove' \| 'backspace'\`<br/> | N
...
drag-sort | \`(context: TagInputDragSortContext)\` | 【开发中】拖拽排序时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface TagInputDragSortContext { newTags: TagInputValue; currentIndex: number; current: string \| number; targetIndex: number; target: string \| number }\`<br/>
...
remove | \`(context: TagInputRemoveContext)\` | 移除单个标签时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tag-input/type.ts)。<br/>\`interface TagInputRemoveContext { value: TagInputValue; index: number; item: string \| number; e?: MouseEvent \| KeyboardEvent; trigger: TagInputRemoveTrigger }\`<br/><br/>\`type TagInputRemoveTrigger = 'tag-remove' \| 'backspace'\`<br/>
