...
customLocale | String | zh |  组件国际化语言，目前支持: 简体中文(zh)、(tc)、英文(en)、日语(ja)、韩语(ko)、俄语(ru)等六种语言 | N
...
format | String | undefined | 用于格式化 pick、change、confirm 事件返回的值，全局配置默认为：'YYYY-MM-DD HH:mm:ss' [详细文档](https://day.js.org/docs/en/display/format) | N
...
header | TNode | - | 头部内容。TS 类型：\`TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
popupProps | Object | {} | 透传 Popup 组件全部属性。TS 类型：\`PopupProps\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/date-time-picker/type.ts) | N
...
value | String / Number | - | 选中值。TS 类型：\`DateValue\` \`type DateValue = string \| number\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/date-time-picker/type.ts) | N
defaultValue | String / Number | - | 选中值。非受控属性。TS 类型：\`DateValue\` \`type DateValue = string \| number\`。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/date-time-picker/type.ts) | N
visible | Boolean | false | 是否显示 | N
onCancel | Function |  | TS 类型：\`(context: { e: MouseEvent }) => void\`<br/>取消按钮点击时触发 | N
onCancel | Function |  | TS 类型：\`() => void\`<br/>取消按钮点击时触发 | N
onChange | Function |  | TS 类型：\`(value: DateValue) => void\`<br/>value改变时触发 | N
onChange | Function |  | TS 类型：\`(value: DateValue) => void\`<br/>确认按钮点击时触发 | N
onClose | Function |  | TS 类型：\`(trigger: TriggerSource) => void\`<br/>关闭时触发。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/date-time-picker/type.ts)。<br/>\`type TriggerSource = 'overlay' \| 'cancel-btn' \| 'confirm-btn'\`<br/> | N
