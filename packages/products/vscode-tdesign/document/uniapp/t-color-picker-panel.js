...
onChange | Function |  | TS 类型：\`(value: string, context: { color: ColorObject; trigger: ColorPickerChangeTrigger }) => void\`<br/>选中的色值发生变化时触发，第一个参数 \`value\` 表示新色值，\`context.color\` 表示当前调色板控制器的色值，\`context.trigger\` 表示触发颜色变化的来源。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/color-picker-panel/type.ts)。<br/>\`type ColorPickerChangeTrigger = 'palette-saturation-brightness' \| 'palette-saturation' \| 'palette-brightness' \| 'palette-hue-bar' \| 'palette-alpha-bar' \| 'input' \| 'preset' \| 'recent' \`<br/> | N
onPaletteBarChange | Function |  | TS 类型：\`(context: { color: ColorObject }) => void\`<br/>调色板控制器的值变化时触发，\`context.color\` 指调色板控制器的值。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/color-picker-panel/type.ts)。<br/>\`interface ColorObject { alpha: number; css: string; hex: string; hex8: string; hsl: string; hsla: string; hsv: string; hsva: string; rgb: string; rgba: string; saturation: number; value: number; isGradient: boolean; linearGradient?: string; }\`<br/> | N
...
名称 | 参数 | 描述
-- | -- | --
change | \`(value: string, context: { color: ColorObject; trigger: ColorPickerChangeTrigger })\` | 选中的色值发生变化时触发，第一个参数 \`value\` 表示新色值，\`context.color\` 表示当前调色板控制器的色值，\`context.trigger\` 表示触发颜色变化的来源。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/color-picker-panel/type.ts)。<br/>\`type ColorPickerChangeTrigger = 'palette-saturation-brightness' \| 'palette-saturation' \| 'palette-brightness' \| 'palette-hue-bar' \| 'palette-alpha-bar' \| 'input' \| 'preset' \| 'recent' \`<br/>
palette-bar-change | \`(context: { color: ColorObject })\` | 调色板控制器的值变化时触发，\`context.color\` 指调色板控制器的值。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/color-picker-panel/type.ts)。<br/>\`interface ColorObject { alpha: number; css: string; hex: string; hex8: string; hsl: string; hsla: string; hsv: string; hsva: string; rgb: string; rgba: string; saturation: number; value: number; isGradient: boolean; linearGradient?: string; }\`<br/>
