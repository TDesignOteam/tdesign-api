...
label | String / Boolean / TNode | true | 进度百分比，可自定义。TS 类型：\`string \| boolean \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
strokeWidth | String / Number | - | 进度条线宽，默认单位 \`px\` | N
