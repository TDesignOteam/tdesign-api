...
placement | String | top | 浮层出现位置。TS 类型：\`PopupPlacement\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/tooltip/type.ts) | N
...
content | String / TNode | - | 文字提示内容。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
