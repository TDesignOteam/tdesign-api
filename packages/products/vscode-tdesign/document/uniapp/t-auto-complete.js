...
children | String / TNode | - | 触发显示联想词下拉框的元素，同 \`triggerElement\`。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
clearable | Boolean | - | 是否允许清空 | N
default | String / TNode | - | 触发显示联想词下拉框的元素，同 \`triggerElement\`。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
disabled | Boolean | undefined | 是否禁用 | N
empty | String / TNode | - | 当下拉联想词列表为空时显示的内容。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
...
inputProps | Object | - | 透传 Input 组件全部特性。TS 类型：\`InputProps\`，[Input API Documents](./input?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/auto-complete/type.ts) | N
...
popupProps | Object | - | 透传 Popup 组件全部属性。TS 类型：\`PopupProps\`，[Popup API Documents](./popup?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/auto-complete/type.ts) | N
...
textareaProps | Object | - | 透传 Textarea 组件全部特性。TS 类型：\`TextareaProps\`，[Textarea API Documents](./textarea?tab=api)。[详细类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/auto-complete/type.ts) | N
...
triggerElement | String / TNode | - | 触发显示联想词下拉框的元素，默认为 Input 组件，可以使用 \`trigger\` 自定义为 Textarea 组件或其他组件。TS 类型：\`string \| TNode\`。[通用类型定义](https://github.com/novlan1/tdesign-uniapp/blob/develop/packages/tdesign/common/common.ts) | N
