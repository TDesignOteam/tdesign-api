import { MapItem, MapOptions } from './types.ts';
...
export const COMPONENTS_PC: Array<MapItem> = [
  ...
  { value: 'ChatList', label: '对话列表' },
  { value: 'ChatSender', label: '对话输入' },
  { value: 'ChatMessage', label: '对话消息体' },
  { value: 'ChatActionbar', label: '对话操作' },
  { value: 'ChatMarkdown', label: 'Markdown内容' },
  { value: 'ChatThinking', label: '思考过程' },
  { value: 'ChatLoading', label: '对话加载' },
  { value: 'Attachments', label: '文件附件' },
  { value: 'ChatContent', label: '对话正文' },
